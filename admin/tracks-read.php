    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 mb-2">
                <h5 class="admin-heading">All Tracks</h5>
            </div>
            <div class="col-md-2">
                <a class="add-new" href="tracks-insert.php" style="border-radius:16px; margin-bottom:25px">Add Tracks</a>
            </div>
            <div class="col-md-12" style="overflow:scroll">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class='edit'><a href='tracks-update.php?id=<?php echo ($row["aid"]) ?>'><i class='fa fa-edit'></i></a></td>
                                    <td class='delete'><a href='tracks-delete.php?id=<?php echo ($row["aid"]) ?>'><i class='fa fa-trash'></i></a></td>
                                </tr>
                        <?php $serial_num++;
                            }
                        } ?>
                ...
                <?php
                $sql_user_show_by_page = "SELECT * FROM tracks WHERE active_record = 'Yes'";
                ...
                if (mysqli_num_rows($result_sql_user_show_by_page) > 0) {
                    ...
                    if ($page_num_index_by_addbar > 1) {
                        echo ("<li><a href='tracks-read.php?page_num_index=" . ($page_num_index_by_addbar - 1) . "'>Prev</a></li>");
                    }
                    for ($i = 1; $i <= $total_page; $i++) {
                        ...
                        echo ("<li class=$active_page><a href='tracks-read.php?page_num_index=$i'>$i</a></li>");
                    }
                    if ($page_num_index_by_addbar < $total_page) {
                        echo ("<li><a href='tracks-read.php?page_num_index=" . ($page_num_index_by_addbar + 1) . "'>Next</a></li>");
                    }
                    echo ("</ul>");
                }
                ?>
