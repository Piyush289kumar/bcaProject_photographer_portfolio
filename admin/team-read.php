    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mb-2">
                <h5 class="admin-heading">All Team Member</h5>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-12" style="overflow:scroll">
                <table class="content-table">
                    ...
                    <tbody>
                        ...
                        $sql_show_user = "SELECT * FROM team WHERE active_record = 'Yes' ORDER BY aid DESC LIMIT {$offset},{$record_limit}";
                ...
                <?php
                $sql_user_show_by_page = "SELECT * FROM team WHERE active_record = 'Yes'";
                ...
                if (mysqli_num_rows($result_sql_user_show_by_page) > 0) {
                    ...
                    if ($page_num_index_by_addbar > 1) {
                        echo ("<li><a href='team-read.php?page_num_index=" . ($page_num_index_by_addbar - 1) . "'>Prev</a></li>");
                    }
                    for ($i = 1; $i <= $total_page; $i++) {
                        ...
                        echo ("<li class=$active_page><a href='team-read.php?page_num_index=$i'>$i</a></li>");
                    }
                    if ($page_num_index_by_addbar < $total_page) {
                        echo ("<li><a href='team-read.php?page_num_index=" . ($page_num_index_by_addbar + 1) . "'>Next</a></li>");
                    }
                    echo ("</ul>");
                }
                ?>
